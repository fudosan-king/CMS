    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_image', models.ForeignKey(blank=True, help_text='Best size for this image will be 1400x400', null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.BuildingImage')),
            ],
            options={
                'abstract': False,
            },
